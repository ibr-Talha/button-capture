...
nesne.onmouseover = function (e) {
    ...
    sayac === 10 ? window.alert(sayac + "Devam etmek istiyor musun ?") : sayac++;
    sayac === 10 ? document.body.style.background = randomColor() : document.getElementById("icerik").innerHTML = "";
    if (sayac >= 50) {
